...
public abstract class BaseFragment extends SupportFragment
        implements BaseView, LifecycleProvider<FragmentEvent> {
    ...
    protected abstract void initButterKnife(View contentView);
